...
public class ReksadanaSwitchingResourceIT {
    ...
    private static final Long DEFAULT_TARGET_REKSADANA_ID = 1L;
    private static final Long UPDATED_TARGET_REKSADANA_ID = 2L;

    private static final Long DEFAULT_CURRENCY_ID = 1L;
    private static final Long UPDATED_CURRENCY_ID = 2L;

    private static final Long DEFAULT_BUY_ORDER_ID = 1L;
    private static final Long UPDATED_BUY_ORDER_ID = 2L;

    private static final Long DEFAULT_SELL_ORDER_ID = 1L;
    private static final Long UPDATED_SELL_ORDER_ID = 2L;
    ...
    public static ReksadanaSwitching createEntity(EntityManager em) {
        ReksadanaSwitching reksadanaSwitching = new ReksadanaSwitching()
            ...
            .targetReksadanaId(DEFAULT_TARGET_REKSADANA_ID)
            .currencyId(DEFAULT_CURRENCY_ID)
            .buyOrderId(DEFAULT_BUY_ORDER_ID)
            .sellOrderId(DEFAULT_SELL_ORDER_ID)
    ...
    public static ReksadanaSwitching createUpdatedEntity(EntityManager em) {
        ReksadanaSwitching reksadanaSwitching = new ReksadanaSwitching()
            ...
            .targetReksadanaId(UPDATED_TARGET_REKSADANA_ID)
            .currencyId(UPDATED_CURRENCY_ID)
            .buyOrderId(UPDATED_BUY_ORDER_ID)
            .sellOrderId(UPDATED_SELL_ORDER_ID)
    ...
    public void createReksadanaSwitching() throws Exception {
        ...
        assertThat(testReksadanaSwitching.getReksadanaId()).isEqualTo(DEFAULT_REKSADANA_ID);
        assertThat(testReksadanaSwitching.getTargetReksadanaId()).isEqualTo(DEFAULT_TARGET_REKSADANA_ID);
        assertThat(testReksadanaSwitching.getCurrencyId()).isEqualTo(DEFAULT_CURRENCY_ID);
        assertThat(testReksadanaSwitching.getBuyOrderId()).isEqualTo(DEFAULT_BUY_ORDER_ID);
        assertThat(testReksadanaSwitching.getSellOrderId()).isEqualTo(DEFAULT_SELL_ORDER_ID);
    ...
    public void getAllReksadanaSwitchings() throws Exception {
        ...
        restReksadanaSwitchingMockMvc.perform(get("/api/reksadana-switchings?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].targetReksadanaId").value(hasItem(DEFAULT_TARGET_REKSADANA_ID.intValue())))
            .andExpect(jsonPath("$.[*].currencyId").value(hasItem(DEFAULT_CURRENCY_ID.intValue())))
            .andExpect(jsonPath("$.[*].buyOrderId").value(hasItem(DEFAULT_BUY_ORDER_ID.intValue())))
            .andExpect(jsonPath("$.[*].sellOrderId").value(hasItem(DEFAULT_SELL_ORDER_ID.intValue())))
    ...
    public void getReksadanaSwitching() throws Exception {
        ...
        restReksadanaSwitchingMockMvc.perform(get("/api/reksadana-switchings/{id}", reksadanaSwitching.getId()))
            ...
            .andExpect(jsonPath("$.targetReksadanaId").value(DEFAULT_TARGET_REKSADANA_ID.intValue()))
            .andExpect(jsonPath("$.currencyId").value(DEFAULT_CURRENCY_ID.intValue()))
            .andExpect(jsonPath("$.buyOrderId").value(DEFAULT_BUY_ORDER_ID.intValue()))
            .andExpect(jsonPath("$.sellOrderId").value(DEFAULT_SELL_ORDER_ID.intValue()))
    ...
    public void updateReksadanaSwitching() throws Exception {
        ...
        assertThat(testReksadanaSwitching.getReksadanaId()).isEqualTo(UPDATED_REKSADANA_ID);
        assertThat(testReksadanaSwitching.getTargetReksadanaId()).isEqualTo(UPDATED_TARGET_REKSADANA_ID);
        assertThat(testReksadanaSwitching.getCurrencyId()).isEqualTo(UPDATED_CURRENCY_ID);
        assertThat(testReksadanaSwitching.getBuyOrderId()).isEqualTo(UPDATED_BUY_ORDER_ID);
        assertThat(testReksadanaSwitching.getSellOrderId()).isEqualTo(UPDATED_SELL_ORDER_ID);
