...
public class ReksadanaResourceIT {
    ...
    private static final Double DEFAULT_BIAYA_PEMBELIAN = 1D;
    private static final Double UPDATED_BIAYA_PEMBELIAN = 2D;

    private static final Double DEFAULT_BIAYA_PENJUALAN = 1D;
    private static final Double UPDATED_BIAYA_PENJUALAN = 2D;

    private static final Double DEFAULT_BIAYA_SWITCHING = 1D;
    private static final Double UPDATED_BIAYA_SWITCHING = 2D;
    ...
    private static final Long DEFAULT_JENIS_REKSADANA_ID = 1L;
    private static final Long UPDATED_JENIS_REKSADANA_ID = 2L;

    private static final Long DEFAULT_KATEGORI_REKSADANA_ID = 1L;
    private static final Long UPDATED_KATEGORI_REKSADANA_ID = 2L;
    ...
    public static Reksadana createEntity(EntityManager em) {
        Reksadana reksadana = new Reksadana()
            ...
            .jenisReksadanaId(DEFAULT_JENIS_REKSADANA_ID)
            .kategoriReksadanaId(DEFAULT_KATEGORI_REKSADANA_ID)
    ...
    public static Reksadana createUpdatedEntity(EntityManager em) {
        Reksadana reksadana = new Reksadana()
            ...
            .jenisReksadanaId(UPDATED_JENIS_REKSADANA_ID)
            .kategoriReksadanaId(UPDATED_KATEGORI_REKSADANA_ID)
    ...
    public void createReksadana() throws Exception {
        ...
        assertThat(testReksadana.getJenisReksadanaId()).isEqualTo(DEFAULT_JENIS_REKSADANA_ID);
        assertThat(testReksadana.getKategoriReksadanaId()).isEqualTo(DEFAULT_KATEGORI_REKSADANA_ID);
    ...
    public void getAllReksadanas() throws Exception {
        ...
        restReksadanaMockMvc.perform(get("/api/reksadanas?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].biayaPembelian").value(hasItem(DEFAULT_BIAYA_PEMBELIAN.doubleValue())))
            .andExpect(jsonPath("$.[*].biayaPenjualan").value(hasItem(DEFAULT_BIAYA_PENJUALAN.doubleValue())))
            .andExpect(jsonPath("$.[*].biayaSwitching").value(hasItem(DEFAULT_BIAYA_SWITCHING.doubleValue())))
            ...
            .andExpect(jsonPath("$.[*].jenisReksadanaId").value(hasItem(DEFAULT_JENIS_REKSADANA_ID.intValue())))
            .andExpect(jsonPath("$.[*].kategoriReksadanaId").value(hasItem(DEFAULT_KATEGORI_REKSADANA_ID.intValue())))
    ...
    public void getReksadana() throws Exception {
        ...
        restReksadanaMockMvc.perform(get("/api/reksadanas/{id}", reksadana.getId()))
            ...
            .andExpect(jsonPath("$.biayaPembelian").value(DEFAULT_BIAYA_PEMBELIAN.doubleValue()))
            .andExpect(jsonPath("$.biayaPenjualan").value(DEFAULT_BIAYA_PENJUALAN.doubleValue()))
            .andExpect(jsonPath("$.biayaSwitching").value(DEFAULT_BIAYA_SWITCHING.doubleValue()))
            ...
            .andExpect(jsonPath("$.jenisReksadanaId").value(DEFAULT_JENIS_REKSADANA_ID.intValue()))
            .andExpect(jsonPath("$.kategoriReksadanaId").value(DEFAULT_KATEGORI_REKSADANA_ID.intValue()))
    ...
    public void updateReksadana() throws Exception {
        ...
        assertThat(testReksadana.getJenisReksadanaId()).isEqualTo(UPDATED_JENIS_REKSADANA_ID);
        assertThat(testReksadana.getKategoriReksadanaId()).isEqualTo(UPDATED_KATEGORI_REKSADANA_ID);
