...
public class ReksadanaSwitching implements Serializable {
    ...
    @JsonIgnore
    private ReksadanaTransaction buy;

    @OneToOne(mappedBy = "sellOrder")
    @JsonIgnore
    private ReksadanaTransaction sell;

    @ManyToOne
    @JsonIgnoreProperties("sourceReks")
    private Reksadana source;

    @ManyToOne
    @JsonIgnoreProperties("targetReks")
    private Reksadana target;
    ...
    public ReksadanaTransaction getBuy() {
        return buy;
    }

    public ReksadanaSwitching buy(ReksadanaTransaction reksadanaTransaction) {
        this.buy = reksadanaTransaction;
        return this;
    }

    public void setBuy(ReksadanaTransaction reksadanaTransaction) {
        this.buy = reksadanaTransaction;
    }

    public ReksadanaTransaction getSell() {
        return sell;
    }

    public ReksadanaSwitching sell(ReksadanaTransaction reksadanaTransaction) {
        this.sell = reksadanaTransaction;
        return this;
    }

    public void setSell(ReksadanaTransaction reksadanaTransaction) {
        this.sell = reksadanaTransaction;
    }

    public Reksadana getSource() {
        return source;
    }

    public ReksadanaSwitching source(Reksadana reksadana) {
        this.source = reksadana;
        return this;
    }

    public void setSource(Reksadana reksadana) {
        this.source = reksadana;
    }

    public Reksadana getTarget() {
        return target;
    }

    public ReksadanaSwitching target(Reksadana reksadana) {
        this.target = reksadana;
        return this;
    }

    public void setTarget(Reksadana reksadana) {
        this.target = reksadana;
    }
