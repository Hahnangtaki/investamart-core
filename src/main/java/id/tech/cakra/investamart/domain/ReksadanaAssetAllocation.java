...
public class ReksadanaAssetAllocation implements Serializable {
    ...
    @Column(name = "asset_value", precision = 21, scale = 2)
    ...
    @ManyToOne
    @JsonIgnoreProperties("reksadanaAssetAllocations")
    ...
    public ReksadanaAssetAllocation assetValue(BigDecimal assetValue) {
    ...
    public ReksadanaAssetAllocation reksadana(Reksadana reksadana) {
