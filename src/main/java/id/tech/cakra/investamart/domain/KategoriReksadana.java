...
public class KategoriReksadana implements Serializable {
    ...
    @OneToMany(mappedBy = "kategoriReksadana")
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    ...
    public KategoriReksadana reksadanas(Set<Reksadana> reksadanas) {
        this.reksadanas = reksadanas;
        return this;
    }

    public KategoriReksadana addReksadana(Reksadana reksadana) {
        this.reksadanas.add(reksadana);
        reksadana.setKategoriReksadana(this);
        return this;
    }

    public KategoriReksadana removeReksadana(Reksadana reksadana) {
        this.reksadanas.remove(reksadana);
        reksadana.setKategoriReksadana(null);
        return this;
    }
