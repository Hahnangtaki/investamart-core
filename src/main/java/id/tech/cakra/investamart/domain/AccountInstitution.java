...
public class AccountInstitution implements Serializable {
    ...
    public AccountInstitution companyChracteristic(String companyChracteristic) {
    ...
    public AccountInstitution bussinessRegNo(String bussinessRegNo) {
    ...
    public AccountInstitution imageCertArticleAssociation(String imageCertArticleAssociation) {
    ...
    public AccountInstitution imageMgmtStructure(String imageMgmtStructure) {
    ...
    public AccountInstitution imageSiup(String imageSiup) {
    ...
    public AccountInstitution imageCertDomicile(String imageCertDomicile) {
    ...
    public AccountInstitution imageCertIncorporation(String imageCertIncorporation) {
    ...
    public AccountInstitution imageNPWP(String imageNPWP) {
    ...
    public AccountInstitution imageAuditedFinancial(String imageAuditedFinancial) {
    ...
    public AccountInstitution imageShareHolder(String imageShareHolder) {
    ...
    public AccountInstitution companyCharacteristicText(String companyCharacteristicText) {
    ...
    public AccountInstitution investmentObjectiveText(String investmentObjectiveText) {
    ...
    public AccountInstitution bussinessRegExpDate(LocalDate bussinessRegExpDate) {
    ...
    public AccountInstitution businessTypeText(String businessTypeText) {
    ...
    public AccountInstitution investExperience(String investExperience) {
    ...
    public AccountInstitution investExperienceText(String investExperienceText) {
    ...
    public AccountInstitution businessFields(String businessFields) {
    ...
    public AccountInstitution businessFieldsText(String businessFieldsText) {
    ...
    public AccountInstitution companyDomicileStatus(String companyDomicileStatus) {
    ...
    public AccountInstitution companyDomicileSince(LocalDate companyDomicileSince) {
    ...
    public AccountInstitution companyWebAddress(String companyWebAddress) {
    ...
    public AccountInstitution companyEstablishCertificate(String companyEstablishCertificate) {
