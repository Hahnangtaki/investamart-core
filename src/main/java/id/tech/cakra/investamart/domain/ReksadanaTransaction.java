...
public class ReksadanaTransaction implements Serializable {
    ...
    private ReksadanaSwitching buyOrder;

    @OneToOne
    @JoinColumn(unique = true)
    private ReksadanaSwitching sellOrder;
    ...
    public ReksadanaSwitching getBuyOrder() {
        return buyOrder;
    }

    public ReksadanaTransaction buyOrder(ReksadanaSwitching reksadanaSwitching) {
        this.buyOrder = reksadanaSwitching;
        return this;
    }

    public void setBuyOrder(ReksadanaSwitching reksadanaSwitching) {
        this.buyOrder = reksadanaSwitching;
    }

    public ReksadanaSwitching getSellOrder() {
        return sellOrder;
    }

    public ReksadanaTransaction sellOrder(ReksadanaSwitching reksadanaSwitching) {
        this.sellOrder = reksadanaSwitching;
        return this;
    }

    public void setSellOrder(ReksadanaSwitching reksadanaSwitching) {
        this.sellOrder = reksadanaSwitching;
    }
