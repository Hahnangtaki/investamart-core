...
public interface ReksadanaTransactionService {
    ...
    /**
     * Get all the ReksadanaTransactionDTO where Buy is {@code null}.
     *
     * @return the list of entities.
     */
    List<ReksadanaTransactionDTO> findAllWhereBuyIsNull();
    /**
     * Get all the ReksadanaTransactionDTO where Sell is {@code null}.
     *
     * @return the list of entities.
     */
    List<ReksadanaTransactionDTO> findAllWhereSellIsNull();
