...
public class ReksadanaSwitchingDTO implements Serializable {
    ...
    private Long reksaSourceId;

    private Long reksaTargetId;
    ...
    public void setOrderBuyId(Long reksadanaTransactionId) {
        this.orderBuyId = reksadanaTransactionId;
    }
    ...
    public void setOrderSellId(Long reksadanaTransactionId) {
        this.orderSellId = reksadanaTransactionId;
    }

    public Long getReksaSourceId() {
        return reksaSourceId;
    }

    public void setReksaSourceId(Long reksadanaId) {
        this.reksaSourceId = reksadanaId;
    }

    public Long getReksaTargetId() {
        return reksaTargetId;
    }

    public void setReksaTargetId(Long reksadanaId) {
        this.reksaTargetId = reksadanaId;
    }
    ...
    public String toString() {
        return "ReksadanaSwitchingDTO{" +
            ...
            ", orderBuy=" + getOrderBuyId() +
            ", orderSell=" + getOrderSellId() +
            ", reksaSource=" + getReksaSourceId() +
            ", reksaTarget=" + getReksaTargetId() +
            "}";
    }
}
