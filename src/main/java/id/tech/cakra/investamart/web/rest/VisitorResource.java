...
public class VisitorResource {
    ...
    private static final String ENTITY_NAME = "investacoresvcVisitor";
     ...
     */
    @GetMapping("/visitors")
    public List<VisitorDTO> getAllVisitors(@RequestParam(required = false) String filter) {
        if ("visitorregisteraccount-is-null".equals(filter)) {
            log.debug("REST request to get all Visitors where visitorRegisterAccount is null");
            return visitorService.findAllWhereVisitorRegisterAccountIsNull();
        }
